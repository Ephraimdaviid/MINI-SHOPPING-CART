let add_to_cart_btns = document.getElementsByClassName("btn btn-primary")
...
let removeBtns = document.getElementsByClassName("uk-button-danger")
    ...
    function addToCart(event) {
        ...
        <td class="uk-text-truncate total-price"><h3>${itemName}</h3></td>
    ...
    function updateTotal(event) {
        ...
        price_field_content = price_field.children[0].innerHTML.replace("$","")
        total_field.children[0].innerHTML =  "$" + number_of_items.value * price_field_content
